...
MobileNet V3 is a deep neural network architecture designed specifically for edge applications. It is known for its lightweight, high accuracy, and fast inference speed, making it an ideal choice for [computer vision at the edge](https://www.picsellia.com/post/optimize-computer-vision-models-on-the-edge). With your cleaned dataset in hand, you can now fine-tune the MobileNet V3 model to better suit your specific use case.
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-1.png)
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-2.png)

![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-3.png)
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-4.png)
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-5.png)

![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-6.png)
*Fig 4: MobileNet’s latest layers are fine-tuned and sharper changes in weight values are observed*

![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-7.png)
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-8.png)
*Fig 6: Severely affected weights of an early layer in the feature extractor.*

‍

Following a similar procedure for my other experiments I gained enough insights into the problem to design a tight search space for the exploitation phase, where Keras-Tuner will find the most optimal values using [Bayesian Optimization](https://www.picsellia.com/post/is-automl-replacing-data-scientists).
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-9.png)
...
![](/images/blog/best-practices-for-fine-tuning-computer-vision-models-img-10.png)
* Fig 8: Evaluation of the final model on the test dataset.*

After the model is deployed you will most probably experience performance degradation due to [data drifts](https://www.picsellia.com/post/what-is-data-drift-and-how-to-detect-it-with-mlops), so having a baseline is important. Using [feedback loops](https://www.picsellia.com/post/feedback-loops-and-versioning-in-computer-vision) is an effective way to combat the performance degradation of deployed machine learning models. 
