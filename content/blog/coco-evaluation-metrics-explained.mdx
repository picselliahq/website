...
As we saw in a previous article about [Confusion Matrixes](/post/the-confusion-matrix-in-computer-vision), evaluation metrics are essential for assessing the performance of computer vision models. In this article, we will take a closer look at the COCO Evaluation Metrics and in particular those that can be found on the [Picsellia platform](/experiment-tracking). 
