...
<BlogInlineCTA
  headline="Train and deploy DINOv2 models with Picsellia"
  description="Go from dataset to deployment. Picsellia handles your training experiments, versioning, and model monitoring in one place."
  ctaText="Start Training →"
  ctaLink="/ai-laboratory"
