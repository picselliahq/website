...
<BlogInlineCTA
  headline="Your DINOv2 features are only as good as your data pipeline"
  description="Picsellia gives you dataset versioning, annotation, experiment tracking, and deployment — everything you need to put DINOv2 into production. No glue code. No MLOps overhead."
  primaryButtonText="Build Your Pipeline for Free →"
