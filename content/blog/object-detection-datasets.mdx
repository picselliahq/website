...
<BlogInlineCTA
  headline="From dataset to deployed model — in one platform"
  description="Import public or custom object detection datasets, annotate them with built-in tools, and train models — all versioned and tracked in Picsellia."
  ctaText="Explore the Datalake →"
  ctaLink="/datalake"
