...
<BlogInlineCTA
  headline="You've found your dataset. Now train on it without the setup headache."
  description="Import COCO, KITTI, Open Images, or your custom dataset directly into Picsellia. Version it, annotate it, run experiments, and deploy — all in one platform."
  primaryButtonText="Start Training for Free →"
