...
![](/images/blog/sahi-computer-vision-tiling-66f6a684cfaf64373c73fd23_66f6a677ce0d587b4bdca0dc_Presentation1-25203.gif)
...
![](/images/blog/sahi-computer-vision-tiling-img-2.png)

### Drop: this is what SAHI did.

![](/images/blog/sahi-computer-vision-tiling-img-3.png)

### Reflect: apply a reflection of the tile until the tile is complete. Similar to a mirror.

![](/images/blog/sahi-computer-vision-tiling-img-4.png)

### Edge: Taks the last row or column of the pixel and repeat it until the tile is complete.

![](/images/blog/sahi-computer-vision-tiling-img-5.png)

### Wrap: Repeat the tile until the tile is complete.

![](/images/blog/sahi-computer-vision-tiling-img-6.png)
...
Picsellia’s approach to tiling empowers developers to achieve better performance in their computer vision models, leading to more precise and efficient model training. [Book your demo](http://picsellia.com/demo) now!
