...
<BlogInlineCTA
  headline="Build any computer vision pipeline on Picsellia"
  description="Whether you're doing detection, segmentation, or classification — Picsellia supports all annotation types and model architectures in one platform."
  ctaText="Explore the Platform →"
  ctaLink="/product-overview"
