...
Picsellia allows you to keep track of your experiments (training) on given datasets in order to ensure reproducibility of your work. To do so, you need a project on [Picsellia](/). 
...
Now that you have trained the first version of your model, you might want to deploy it either at the edge or in the cloud, to do so you can leverage our [Picsellia Serverless Deployment solution](/model-deployment). The only thing that will need to be done is **creating a model** on Picsellia, which will be exported from the experiment (i.e., the training you have just performed ;)). 
...
If you struggle with this part, do not hesitate to [reach out to us](/contact) 🙂
