...
To monitor such changes, you might require out-of-the-box or vision-specific metrics that differ from classical ML performance metrics. Some of these [CV monitoring metrics](https://www.picsellia.com/post/key-metrics-to-monitor-computer-vision-solutions) include:
...
[Picsellia](https://www.picsellia.com/) is a robust [end-to-end CVOps](https://www.picsellia.com/post/creating-a-cvops-platform) platform that offers the following features to assist data scientists and enterprise vision teams: 
...
Moreover, Picsellia offers [supervised and unsupervised metrics](https://www.picsellia.com/post/key-metrics-to-monitor-computer-vision-solutions) to identify any drift and monitor overall CV workflows.

Start using Picsellia’s CVOps platform. [Book your trial](https://www.picsellia.com/trial) today!
