...
// Benefits icon definitions (text comes from translations)
const benefitIcons = [
  (
    <svg
      className="w-5 h-5"
...
const benefitKeys = [
  { titleKey: 'benefits.personalizedTitle', descKey: 'benefits.personalizedDesc' },
  { titleKey: 'benefits.technicalTitle', descKey: 'benefits.technicalDesc' },
  { titleKey: 'benefits.pricingTitle', descKey: 'benefits.pricingDesc' },
] as const;
