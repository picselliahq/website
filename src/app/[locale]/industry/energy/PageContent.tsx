...
export default function EnergyPage() {
  const t = useTranslations('industry.energy');
  return (
    <>
      {/* Hero Section */}
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <div className="flex justify-center mb-8">
            <span className="badge">
              ...
              <span className="text-sm font-medium text-[var(--system-yellow)]">{t('hero.badge')}</span>
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-center max-w-4xl mx-auto mb-6 tracking-tight">
            {t.rich('hero.title', { highlight: (chunks) => <span className="text-[var(--system-yellow)]">{chunks}</span> })}
          </h1>
