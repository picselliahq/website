...
const useCases = [
  {
    ...
    description:
      "Detect scratches, dents, discoloration, and surface anomalies with sub-millimeter precision. Trained on your exact defect taxonomy.",
  ...
  },
  {
    ...
    description:
      "Verify component presence, orientation, and positioning. Catch assembly errors before they reach the next station.",
  ...
  },
  {
    ...
    description:
      "Validate labels, seals, barcodes, and packaging integrity. Ensure every product ships correctly.",
  ...
  },
  {
    ...
    description:
      "Monitor PPE usage, restricted zones, and safety protocols. Protect workers with automated visual checks.",
...
const qualityPillars = [
  {
    ...
    description:
      "Every label is validated by multiple experts. Consensus ensures accuracy.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Benchmark every model version against curated edge cases before deployment.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Track precision and recall for each defect type. No blind spots.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Compare model performance against your best inspectors. Prove ROI.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
export default function ManufacturingPage() {
  const t = useTranslations('industry.manufacturing');
  return (
    <>
      {/* Hero Section */}
      <section className="pt-32 pb-24 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-center max-w-4xl mx-auto mb-6 tracking-tight">
            {t.rich('hero.title', { highlight: (chunks) => <span className="text-[var(--system-blue)]">{chunks}</span> })}
          </h1>
                  ...
                  <div className="card px-4 py-3 bg-[var(--card)]/90 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-bold text-[var(--system-blue)]">
                          99.5%
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card px-4 py-3 bg-[var(--card)]/90 backdrop-blur-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-bold text-[var(--system-indigo)]">
                          On-Premise
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] text-lg mb-8">
                In manufacturing, a false positive stops the line. A missed
                defect ships to customers. That's why we obsess over annotation
                quality — multi-reviewer consensus, expert validation, and
                golden test sets that catch edge cases before they reach
                production.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {qualityPillars.map((pillar) => (
                  <div key={pillar.title} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-base font-semibold text-[var(--label)] mb-1">
                        {pillar.title}
                      </h3>
                ...
                <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <div className="h-2 rounded-full bg-[var(--tertiary-system-background)]">
                      <div
                        className="h-2 rounded-full bg-[var(--picsellia-green)]"
                        style={{ width: "96.8%" }}
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="h-2 rounded-full bg-[var(--tertiary-system-background)]">
                      <div
                        className="h-2 rounded-full bg-[var(--system-blue)]"
                        style={{ width: "100%" }}
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="h-2 rounded-full bg-[var(--tertiary-system-background)]">
                      <div
                        className="h-2 rounded-full bg-[var(--system-indigo)]"
                        style={{ width: "85%" }}
                      />
                    </div>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Every model is evaluated against curated test scenarios before
              deployment. Track per-defect metrics, compare to human baselines,
              ...
              <div className="p-6 border-b border-[var(--border)]">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--system-orange)]/10 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-[var(--system-orange)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <p className="text-sm text-[var(--secondary-label)]">
                  Build test datasets with your hardest cases — lighting
                  variations, rare defects, borderline calls. Every model
                  version runs against them before promotion.
                </p>
              </div>
              ...
              <div className="p-6 border-b border-[var(--border)]">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--system-blue)]/10 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-[var(--system-blue)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <p className="text-sm text-[var(--secondary-label)]">
                  Overall accuracy hides weak spots. Track precision, recall,
                  and F1 for each defect type. Know exactly where your model
              ...
              <div className="p-6 bg-[var(--tertiary-system-background)]">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-mono text-[var(--picsellia-green)]">
                      99.2%
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-mono text-[var(--system-orange)]">
                      94.1%
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="p-6 border-b border-[var(--border)]">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-xl bg-[var(--picsellia-green)]/10 flex items-center justify-center">
                    <svg
                      className="w-6 h-6 text-[var(--picsellia-green)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <p className="text-sm text-[var(--secondary-label)]">
                  Have your inspectors label the same test set. Compare model
                  performance to human accuracy. Quantify the improvement you're
                  getting.
                </p>
              </div>
              <div className="p-6 bg-[var(--tertiary-system-background)]">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[var(--secondary-label)]">
                      87.3%
                    </div>
                    <div className="text-xs text-[var(--tertiary-label)]">
                      Human avg
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[var(--picsellia-green)]">
                      99.5%
                    </div>
                    <div className="text-xs text-[var(--tertiary-label)]">
                      Model
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-16">
            <div>
              ...
              <p className="text-[var(--secondary-label)] max-w-xl">
                From surface inspection to assembly verification, Picsellia
                powers quality control across manufacturing.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 border-b border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Asynchronous monitoring catches drift without blocking the line.
              On-premise deployment keeps your data where it belongs.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="p-8 border-b border-[var(--border)]">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 rounded-2xl bg-[var(--picsellia-green)]/10 flex items-center justify-center">
                    <Image
                      src="/images/community/icons/model-monitoring.svg"
                      alt="Monitoring"
                      width={32}
                      height={32}
                    />
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[var(--tertiary-label)]">
                      Non-blocking production insights
                    </p>
                  </div>
                </div>
                <p className="text-[var(--secondary-label)] mb-6">
                  Your inspection line runs at full speed. Meanwhile, Picsellia
                  samples predictions, tracks confidence trends, and flags
                  anomalies — without adding latency to your process.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="p-3 rounded-lg bg-[var(--tertiary-system-background)]"
                    >
            ...
            <div className="card p-0 overflow-hidden">
              <div className="p-8 border-b border-[var(--border)]">
                ...
                <p className="text-[var(--secondary-label)] mb-6">
                  Manufacturing data is sensitive — product designs, defect
                  patterns, production volumes. Deploy Picsellia entirely on
                  your infrastructure. Air-gapped environments supported.
                </p>
                <div className="space-y-3">
                  {[
          ...
          <div className="mt-12 card p-8">
            <h3 className="text-lg font-semibold text-[var(--label)] mb-6 text-center">
              Deployment Architecture
            </h3>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 rounded-xl bg-[var(--tertiary-system-background)] border border-[var(--border)] text-center">
                ...
                <h4 className="font-semibold text-[var(--label)] mb-2">
                  Edge Inference
                </h4>
                <p className="text-xs text-[var(--secondary-label)]">
                  Models run on industrial PCs at each inspection station.
                  Sub-100ms latency.
                </p>
              </div>
              <div className="p-6 rounded-xl bg-[var(--tertiary-system-background)] border border-[var(--border)] text-center">
                <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-[var(--system-indigo)]/10 flex items-center justify-center">
                  <svg
                    className="w-6 h-6 text-[var(--system-indigo)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <p className="text-xs text-[var(--secondary-label)]">
                  Picsellia platform runs on your data center. Training,
                  labeling, versioning — all local.
                </p>
              </div>
              <div className="p-6 rounded-xl bg-[var(--tertiary-system-background)] border border-[var(--border)] text-center">
                ...
                <p className="text-xs text-[var(--secondary-label)]">
                  Zero internet required. Sync updates via secure media when
                  needed.
                </p>
              </div>
            </div>
          ...
          <div className="card p-0 overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-20 text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-xl mx-auto mb-10 text-lg">
                See how Picsellia delivers 99.5% defect detection with
                on-premise deployment.
              </p>
