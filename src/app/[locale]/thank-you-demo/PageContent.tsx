...
export default function ThankYouDemoContent({ meetingsUrl }: ThankYouDemoContentProps) {
  const t = useTranslations('thankYouDemo');
    ...
    <section className="pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="max-w-2xl mx-auto">
          <h2 className="text-sm font-semibold text-[var(--label)] mb-4 text-center">{t('whatToExpect')}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              {
                title: t('liveWalkthrough'),
                description: t('liveWalkthroughDesc'),
              },
              {
                title: t('nextSteps'),
