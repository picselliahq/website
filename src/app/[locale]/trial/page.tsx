    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <div className="pt-8 border-t border-[var(--border)]">
                <h3 className="text-sm font-semibold text-[var(--label)] mb-4">{t('included.title')}</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="acceptTerms" className="text-sm text-[var(--secondary-label)]">
                      {t('form.termsAgree')}{' '}
                      <Link href="/privacy" className="text-[var(--picsellia-green)] hover:underline">{t('form.termsOfService')}</Link>
                      {' '}{t('form.and')}{' '}
                      <Link href="/privacy" className="text-[var(--picsellia-green)] hover:underline">{t('form.privacyPolicy')}</Link>
                    </label>
                  </div>
                  ...
                  <p className="text-sm text-[var(--tertiary-label)] text-center">
                    {t('form.existingUser')}{' '}
                    <a href="https://app.picsellia.com" className="text-[var(--picsellia-green)] hover:underline">{t('form.signIn')}</a>
                  </p>
                </form>
              </div>
            </div>
      ...
      <section className="py-16 border-t border-[var(--border)]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-sm text-[var(--tertiary-label)] mb-6">{t('socialProof.trustedBy')}</p>
