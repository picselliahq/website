...
const values = [
  {
    ...
    description:
      "Built by ML engineers who understand the daily challenges of production AI. Every feature solves a real problem we faced ourselves.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Transparency",
    description:
      "Full visibility into your ML pipeline. Reproducible experiments, complete data lineage, and no black boxes. You own your data.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Flexibility",
    description:
      "Deploy anywhere—cloud, hybrid, or on-premise. Use your existing tools. Picsellia adapts to your infrastructure, not the other way around.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Simplicity",
    description:
      "Powerful features without complexity. Our platform reduces cognitive load so teams can focus on building great AI, not managing tools.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
...
const leadership = [
  {
    ...
    image: "/images/about/thibaut-lucas.jpg",
  ...
  },
  {
    ...
    image: "/images/about/pierre-nicolas-tiffreau.jpg",
...
// Team members
const teamMembers = [
  { name: "Hicham Bakri", role: "Full-stack Engineer" },
  ...
  { name: "Audrey Martin", role: "Front-end Engineer" },
...
const milestones = [
  {
    year: "2020",
    title: "Founded",
    description: "Picsellia founded in Toulouse, France by two AI engineers",
  },
  {
    year: "2021",
    title: "First Funding",
    description: "Seed funding from Acequia Capital and early backers",
  },
  {
    year: "2022",
    title: "Series Seed",
    description: "$1.94M raised led by Axeleo Capital to accelerate growth",
  },
  {
    year: "2023",
    title: "ISO 27001",
    description: "Achieved ISO/IEC 27001:2022 certification",
  },
  {
    year: "2024",
    title: "1K+ Users",
    description: "Crossed 5,000 models trained and 500M+ images indexed",
  },
  {
    year: "2025",
    title: "Atlas Launch",
    description: "Launched Atlas, our open-source AI agent for VisionAI",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 leading-relaxed max-w-2xl">
              We&apos;re a team of AI engineers on a mission to make computer
              vision accessible to every team. Born from frustration with
              fragmented tools, Picsellia is the platform we wished existed.
            </p>

            <div className="flex flex-wrap gap-8">
              {metrics.map((metric) => (
                <div key={metric.label}>
                  <div className="text-3xl md:text-4xl font-semibold text-[var(--label)]">
                    {metric.value}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-semibold mb-6">
                From experiments to production, without the chaos
              </h2>
              <div className="space-y-6 text-[var(--secondary-label)]">
                <p>
                  In 2020, as AI engineers building computer vision systems, we
                  faced a common frustration: the tools we needed didn&apos;t
                  exist. Data management was scattered across folders.
                  Experiments were tracked in spreadsheets. Deployment was a
                  nightmare of custom scripts.
                </p>
                <p>
                  We built Picsellia to solve these problems—not as consultants
                  or enterprise software veterans, but as practitioners who
                  lived the pain every day. Our platform is shaped by real-world
                  experience deploying CV models at scale.
                </p>
                <p>
                  Today, Picsellia helps teams worldwide turn fragmented
                  workflows into streamlined pipelines. From labeling to
                  monitoring, every feature exists because we needed it
                  ourselves.
                </p>
              </div>
            </div>
            ...
            <div className="card p-8 relative">
              ...
              <blockquote className="text-xl md:text-2xl font-medium text-[var(--label)] leading-relaxed mb-6">
                &ldquo;Picsellia is the kind of tool we had wished existed
                during our early development work. We built it to close the
                operational gaps across the entire computer vision
                lifecycle.&rdquo;
              </blockquote>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              These principles guide everything we build and how we work with
              our customers.
            </p>
          </div>
                ...
                >
                  ...
                  >
                    <div className="card p-6 inline-block text-left relative">
                      ...
                      <div className="text-sm font-semibold text-[var(--system-blue)] mb-1">
                        {milestone.year}
                      </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {leadership.map((person) => (
              <div key={person.name} className="card p-8 text-center">
                ...
                <h3 className="text-xl font-semibold text-[var(--label)] mb-1">
                  {person.name}
                </h3>
                <div className="text-sm text-[var(--picsellia-green)] mb-4">
                  {person.role}
                </div>
      ...
      <section className="py-24 border-b border-[var(--border)] bg-[var(--tertiary-system-background)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              Based in Toulouse, France, with team members and clients around
              the world.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {teamMembers.map((member) => (
              <div key={member.name} className="card p-6 text-center">
                ...
                <h3 className="font-semibold text-[var(--label)] text-sm mb-1">
                  {member.name}
                </h3>
      ...
      <section className="py-24 border-b border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              We&apos;ve raised $3.45M from leading European investors who share
              our vision for the future of MLOps.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
            {investors.map((investor) => (
              <div key={investor.name} className="text-center p-6">
                <div className="text-lg font-semibold text-[var(--label)] mb-1">
                  {investor.name}
                </div>
                <div className="text-xs text-[var(--tertiary-label)]">
                  {investor.type}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Known as the European capital of aerospace, Toulouse is home to
                a thriving tech ecosystem and some of the world&apos;s most
                innovative engineering talent. Our team works from here, serving
                clients across Europe, North America, and beyond.
              </p>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[var(--label)]">Toulouse, France</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg
                    className="w-5 h-5 text-[var(--system-indigo)]"
          ...
          <div className="card p-0 overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-xl mx-auto mb-10 text-lg">
                See how Picsellia can transform your computer vision workflow.
