        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--picsellia-green)]/10 border border-[var(--picsellia-green)]/20 mb-8">
              ...
              <span className="text-sm font-medium text-[var(--picsellia-green)]">Our Story</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold mb-6 tracking-tight leading-[1.1]">
              Building the future of
              <span className="text-[var(--picsellia-green)]"> computer vision</span>
            </h1>

            <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 leading-relaxed max-w-2xl">
              We&apos;re a team of AI engineers on a mission to make computer vision accessible to every team.
              Born from frustration with fragmented tools, Picsellia is the platform we wished existed.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-[var(--secondary-label)]">
                <p>
                  In 2019, as AI engineers building computer vision systems, we faced a common frustration:
                  the tools we needed didn&apos;t exist. Data management was scattered across folders.
                  Experiments were tracked in spreadsheets. Deployment was a nightmare of custom scripts.
                </p>
                <p>
                  We built Picsellia to solve these problems—not as consultants or enterprise software veterans,
                  but as practitioners who lived the pain every day. Our platform is shaped by real-world experience
                  deploying CV models at scale.
                </p>
                <p>
                  Today, Picsellia helps teams worldwide turn fragmented workflows into streamlined pipelines.
                  From labeling to monitoring, every feature exists because we needed it ourselves.
                </p>
              </div>
            </div>
            ...
            <div className="card p-8 relative">
              ...
              <blockquote className="text-xl md:text-2xl font-medium text-[var(--label)] leading-relaxed mb-6">
                &ldquo;Picsellia is the kind of tool we had wished existed during our early development work.
                We built it to close the operational gaps across the entire computer vision lifecycle.&rdquo;
              </blockquote>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              These principles guide everything we build and how we work with our customers.
            </p>
          </div>
      ...
      <section className="py-24 border-b border-[var(--border)] bg-[var(--tertiary-system-background)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              Based in Toulouse, France, with team members and clients around the world.
            </p>
          </div>
      ...
      <section className="py-24 border-b border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              We&apos;ve raised $3.45M from leading European investors who share our vision for the future of MLOps.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Known as the European capital of aerospace, Toulouse is home to a thriving tech ecosystem
                and some of the world&apos;s most innovative engineering talent. Our team works from here,
                serving clients across Europe, North America, and beyond.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[var(--label)]">Serving clients worldwide</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-[var(--system-indigo)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className="text-[var(--label)]">EU data centers, GDPR compliant</span>
                </div>
              </div>
            </div>
