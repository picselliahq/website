        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold mb-6 tracking-tight max-w-4xl mx-auto">
              Train Models{" "}
              <span className="text-[var(--picsellia-green)]">Your Way</span>
            </h1>

            <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-2xl mx-auto">
              From no-code training to custom PyTorch pipelines. Choose your
              level of control and let Picsellia handle the infrastructure.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
              ...
              <div
                key={stat.label}
                className="p-4 border border-[var(--border)] rounded-xl text-center"
              >
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Start with no-code for quick iterations, use the SDK for
              automation, or build fully custom pipelines when you need complete
              control.
            </p>
          </div>
                ...
                <div className="p-4 border-t border-[var(--border)]">
                  <div className="flex flex-wrap gap-2">
                    {mode.features.map((feature) => (
                      <span
                        key={feature}
                        className="px-2 py-1 rounded text-[10px] bg-[var(--tertiary-system-background)] text-[var(--secondary-label)]"
                      >
                        {feature}
                      </span>
                    ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Start training in minutes with our pre-built pipelines.
                Ultralytics for YOLO, SAM2 for segmentation, Grounding DINO for
                zero-shot detection, and more.
              </p>
            ...
            <div className="space-y-4">
              {pipelines.map((pipeline) => (
                <div
                  key={pipeline.name}
                  className="p-4 border border-[var(--border)] rounded-xl hover:border-[var(--system-orange)]/30 transition-colors"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-[var(--tertiary-label)] mb-2">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {pipeline.tasks.map((task) => (
                          <span
                            key={task}
                            className="px-2 py-0.5 rounded text-[10px] bg-[var(--tertiary-system-background)] text-[var(--secondary-label)]"
                          >
                            {task}
                          </span>
                        ))}
      ...
      <section className="py-24 border-b border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Picsellia CV Engine is a modular toolkit for building computer
          ...
          <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="px-4 py-3 border-t border-[var(--border)] bg-[var(--tertiary-system-background)]">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <Link
                    ...
                    className="text-[var(--system-indigo)] hover:underline"
                  >
                    View Docs →
                  </Link>
                </div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={feature.title}
                  className="p-5 border border-[var(--border)] rounded-xl"
                >
                  <div className="flex items-start gap-4">
      ...
      <section className="py-24 border-b border-[var(--border)]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              AI Lab connects directly to datasets, experiment tracking, and
              model deployment. Full lineage from data to production.
            </p>
          </div>
                ...
                <div key={item.name} className="relative">
                  {item.href ? (
                    ...
                    >
                      ...
                      <div
                        className={`text-sm font-medium ${item.active ? "text-[var(--picsellia-green)]" : "text-[var(--label)]"}`}
                      >
                        {item.name}
                      </div>
                    </Link>
                  ...
                  {index < 4 && (
                    <div className="hidden md:block absolute top-1/2 -right-2 transform -translate-y-1/2 z-10">
                      <svg
                        className="w-4 h-4 text-[var(--border)]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
          ...
          <div className="card p-0 overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-xl mx-auto mb-10 text-lg">
                Start with no-code training or build custom pipelines. Zero
