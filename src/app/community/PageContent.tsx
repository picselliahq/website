...
const includedFeatures = [
  {
    ...
    description:
      "Organize, version, and manage all your visual data in one place.",
    features: [
...
const comparisonTable = [
  {
    feature: "Data Processing Units",
    community: "150 DPU/year",
    business: "Custom",
    enterprise: "Unlimited",
  },
  {
    feature: "Model Processing Units",
    community: "—",
    business: "Custom",
    enterprise: "Unlimited",
  },
  {
    feature: "AutoML Training",
    community: "4 runs",
    business: "Unlimited",
    enterprise: "Unlimited",
  },
...
const partnerLogos = [
  ...
  {
    name: "NVIDIA Jetson",
    src: "/images/community/partners/nvidia-jetson.svg",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-lg">
                Get started with data management and AutoML training. No credit
                card, no time limit.
              </p>
              ...
              <div className="flex flex-wrap gap-6 text-sm text-[var(--secondary-label)]">
                {["No credit card", "Instant access", "150 DPU free"].map(
                  (benefit) => (
              ...
              <div className="relative">
                <div className="card p-0 overflow-hidden shadow-2xl">
                  <div className="flex items-center gap-2 px-4 py-3 border-b border-[var(--border)] bg-[var(--tertiary-system-background)]">
                    ...
                    <span className="ml-2 text-xs text-[var(--tertiary-label)]">
                      quickstart.py
                    </span>
                  </div>
                  <pre className="p-6 text-sm overflow-x-auto bg-[var(--black)]">
                    <code>
                      ...
                      <span className="text-[var(--label)]">Client(</span>
                      {"\n"}
                      <span className="text-[var(--label)]"> api_token</span>
                      <span className="text-[var(--system-indigo)]">=</span>
                      ...
                      <span className="text-[var(--label)]">)</span>
                      {"\n"}
                      <span className="text-[var(--label)]">dataset</span>{" "}
                      <span className="text-[var(--system-indigo)]">=</span>{" "}
                      <span className="text-[var(--label)]">
                      ...
                      <span className="text-[var(--label)]">)</span>
                      {"\n"}
                      <span className="text-[var(--label)]">version</span>{" "}
                      <span className="text-[var(--system-indigo)]">=</span>{" "}
                      <span className="text-[var(--label)]">
                      ...
                      {"\n"}
                      <span className="text-[var(--label)]">exp</span>{" "}
                      <span className="text-[var(--system-indigo)]">=</span>{" "}
                      <span className="text-[var(--label)]">
                ...
                <div className="absolute -bottom-8 -left-8 card p-4 shadow-xl bg-[var(--card)] border-[var(--picsellia-green)]/30">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-[var(--picsellia-green)]">
                        mAP: 94.5%
                      </div>
                    </div>
                  </div>
                ...
                <div className="absolute -top-4 -right-4 card px-4 py-2 shadow-xl bg-[var(--card)]">
                  ...
                  <div className="text-lg font-bold text-[var(--label)] font-mono">
                    4 runs
                  </div>
                </div>
              </div>
            ...
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="flex items-baseline justify-center gap-1">
                  <span className="text-3xl md:text-4xl font-bold text-[var(--label)]">
                    {stat.value}
                  </span>
                  <span className="text-sm text-[var(--picsellia-green)] font-medium">
                    {stat.unit}
                  </span>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              The Community Edition gives you data management and AutoML
              training to get started with computer vision.
            </p>
          </div>
                    ...
                    {feature.features.map((item) => (
                      <li key={item} className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            backgroundColor: `color-mix(in srgb, ${feature.color} 20%, transparent)`,
                          }}
                        >
                          <svg
                            className="w-3 h-3"
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[var(--secondary-label)]">
                  Labeling tools, annotation campaigns, model deployment,
                  monitoring, team collaboration, and unlimited training are
                  available on{" "}
                  <Link
                    href="/pricing"
                    className="text-[var(--system-orange)] hover:underline"
                  >
      ...
      <section className="py-24 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              Start free and upgrade as your needs grow. No pressure, no
              lock-in.
            </p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[var(--border)] bg-[var(--tertiary-system-background)]">
                    <th className="text-left p-5 text-sm font-medium text-[var(--tertiary-label)]">
                      Feature
                    </th>
                    <th className="text-center p-5 min-w-[140px]">
                      <div className="inline-flex flex-col items-center gap-1">
                        <span className="px-3 py-1 rounded-full bg-[var(--picsellia-green)]/10 text-sm font-semibold text-[var(--picsellia-green)]">
                          Community
                        </span>
                ...
                <tbody>
                  {comparisonTable.map((row, index) => (
                    ...
                    >
                      <td className="p-5 text-sm text-[var(--secondary-label)]">
                        {row.feature}
                      </td>
                      <td className="p-5 text-center text-sm text-[var(--label)] font-medium">
                        {row.community}
                      </td>
                      <td className="p-5 text-center text-sm text-[var(--secondary-label)]">
                        {row.business}
                      </td>
                      <td className="p-5 text-center text-sm text-[var(--secondary-label)]">
                        {row.enterprise}
          ...
          <div className="card p-12 md:p-20 text-center relative overflow-hidden border-[var(--picsellia-green)]/20">
            ...
            <div className="relative">
              ...
              <p className="text-[var(--secondary-label)] max-w-lg mx-auto mb-10 text-lg">
                Get data management and AutoML training for free. Upgrade when
                you need the full platform.
              </p>
              <Link
                href="https://app.picsellia.com/signup"
                target="_blank"
