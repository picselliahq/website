          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-lg">
                Get started with data management and AutoML training.
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-xl mx-auto">
              The Community Edition gives you data management and AutoML training to get started with computer vision.
            </p>
          </div>
          ...
          <div className="mt-8 card p-6 bg-[var(--tertiary-system-background)]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-[var(--label)] mb-1">Need more?</h4>
                <p className="text-sm text-[var(--secondary-label)]">
                  Labeling tools, annotation campaigns, model deployment, monitoring, team collaboration,
                  and unlimited training are available on{' '}
          ...
          <div className="card p-12 md:p-20 text-center relative overflow-hidden border-[var(--picsellia-green)]/20">
            ...
            <div className="relative">
              ...
              <p className="text-[var(--secondary-label)] max-w-lg mx-auto mb-10 text-lg">
                Get data management and AutoML training for free.
                Upgrade when you need the full platform.
              </p>
              <Link
                href="https://app.picsellia.com/signup"
