        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--system-indigo)]/10 border border-[var(--system-indigo)]/20 mb-8">
              ...
              <span className="text-sm font-medium text-[var(--system-indigo)]">Enterprise Deployment</span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold mb-6 tracking-tight max-w-4xl mx-auto">
              Enterprise Deployment & <span className="text-[var(--system-indigo)]">Security</span>
            </h1>

            <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-2xl mx-auto">
              Enterprise-grade deployment from fully managed SaaS to air-gapped on-premise. Deploy Picsellia where your data lives,
              ...
              <div key={option.id} className="card p-0 overflow-hidden flex flex-col">
                <div className="p-6 border-b border-[var(--border)]">
                  ...
                  >
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={option.iconPath} />
                    </svg>
                  </div>
                ...
                <div className="p-4 border-t border-[var(--border)] bg-[var(--tertiary-system-background)]">
                  <p className="text-xs text-[var(--tertiary-label)]">
                    <span className="font-medium text-[var(--secondary-label)]">Best for:</span> {option.bestFor}
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  { label: 'Cloud Storage', desc: 'AWS S3, Google Cloud Storage, Azure Blob', iconPath: 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4' },
                  { label: 'GPU Compute', desc: 'Your AWS, GCP, or Azure GPU instances', iconPath: 'M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z' },
                  { label: 'Docker Registry', desc: 'ECR, GCR, ACR, or private registries', iconPath: 'M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4' },
                ].map((item) => (
            ...
            <div className="card p-6">
              <div className="text-xs font-medium text-[var(--tertiary-label)] uppercase tracking-wider mb-6">Architecture Overview</div>

              <div className="space-y-4">
                <div className="p-4 rounded-lg border-2 border-dashed border-[var(--system-blue)]/30 bg-[var(--system-blue)]/5">
                  <div className="text-xs font-semibold text-[var(--system-blue)] mb-3">Your Infrastructure</div>
                ...
                <div className="p-4 rounded-lg border border-[var(--picsellia-green)]/30 bg-[var(--picsellia-green)]/5">
                  <div className="text-xs font-semibold text-[var(--picsellia-green)] mb-3">Picsellia Control Plane</div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="card p-8 md:p-12 mb-16 relative overflow-hidden border-[var(--system-indigo)]/20">
            ...
            <div className="relative text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-2xl mx-auto mb-8">
                Run the entire Picsellia MLOps platform on your own infrastructure.
                Full data sovereignty, air-gapped capable, with enterprise-grade support included.
              </p>
              <div className="flex flex-wrap justify-center gap-3 mb-8">
                {['Kubernetes & Docker', 'Air-Gapped', 'Bare Metal', 'Custom SLAs', 'SSO / SAML', 'Full Isolation'].map(tag => (
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Deploy the complete Picsellia stack in your own data center or private cloud.
                Support for Kubernetes clusters or simple Docker Compose setups.
              </p>
      ...
      <section className="py-24 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Fine-grained permissions at every level. Control who can access what,
              from organization-wide settings down to individual projects.
            </p>
          </div>
          ...
          <div className="mt-12 card p-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h3 className="text-lg font-semibold text-[var(--label)] mb-1">Custom roles coming soon</h3>
          ...
          <div className="card p-0 overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-xl mx-auto mb-10 text-lg">
                Our enterprise team can help you choose the right deployment model,
                answer compliance questions, and design a custom solution.
              </p>
