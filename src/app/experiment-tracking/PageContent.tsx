...
const logTypes = [
  {
    name: "Scalar",
    description: "Single values (loss, accuracy)",
  ...
  {
    name: "Image",
    description: "Visualizations & samples",
  ...
  const lines = [
    {
      name: "train_loss",
      color: "var(--system-blue)",
      points: [0.9, 0.7, 0.5, 0.35, 0.25, 0.18, 0.12, 0.09],
    },
    {
      name: "val_loss",
      color: "var(--system-orange)",
      points: [0.95, 0.75, 0.55, 0.42, 0.35, 0.3, 0.28, 0.27],
    },
    {
      name: "mAP",
      color: "var(--picsellia-green)",
      points: [0.1, 0.25, 0.45, 0.58, 0.68, 0.75, 0.82, 0.87],
    },
  ];
        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b border-[var(--border)] bg-[var(--black)]">
              <th className="px-4 py-2 text-left text-[var(--tertiary-label)] font-medium">
                Name
              </th>
              <th className="px-4 py-2 text-right text-[var(--tertiary-label)] font-medium">
                mAP
              </th>
              <th className="px-4 py-2 text-right text-[var(--tertiary-label)] font-medium">
                Loss
              ...
              <th className="px-4 py-2 text-center text-[var(--tertiary-label)] font-medium">
                Status
              </th>
            </tr>
          </thead>
          <tbody>
            {experiments.map((exp, i) => (
              <tr
                key={exp.name}
                className={`border-b border-[var(--border)] ${i === 2 ? "bg-[var(--picsellia-green)]/5" : ""}`}
              >
                <td className="px-4 py-3 font-mono text-[var(--label)]">
                  {exp.name}
                </td>
                <td className="px-4 py-3 text-right font-mono text-[var(--picsellia-green)]">
                  {exp.mAP.toFixed(2)}
                </td>
                <td className="px-4 py-3 text-right font-mono text-[var(--system-orange)]">
                  {exp.loss.toFixed(2)}
                </td>
                <td className="px-4 py-3 text-right font-mono text-[var(--secondary-label)]">
                  {exp.lr}
                </td>
                <td className="px-4 py-3 text-right font-mono text-[var(--secondary-label)]">
                  {exp.epochs}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-lg">
                ...
                Compare runs, collaborate with your team, and version models
                automatically.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Capture metrics, parameters, artifacts, and evaluations with a
              simple API. Full lineage tracking with minimal integration code.
            </p>
          </div>
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    ...
                    style={{
                      backgroundColor: `color-mix(in srgb, ${type.color} 15%, transparent)`,
                    }}
                  >
                    {type.icon === "number" && (
                      <span
            ...
            <div className="card p-0 overflow-hidden">
              ...
              <pre className="p-5 text-xs overflow-x-auto bg-[var(--black)] font-mono leading-relaxed">
                <code>
                  ...
                  <span className="text-[var(--label)]">Client()</span>
                  {"\n"}
                  <span className="text-[var(--label)]">project</span>{" "}
                  <span className="text-[var(--system-indigo)]">=</span>{" "}
                  ...
                  {"\n"}
                  <span className="text-[var(--label)]">experiment</span>{" "}
                  <span className="text-[var(--system-indigo)]">=</span>{" "}
                  <span className="text-[var(--label)]">
                  ...
                  <span className="text-[var(--label)]">:</span>{" "}
                  <span className="text-[var(--system-orange)]">1e-4</span>
                  <span className="text-[var(--label)]">,</span>
                  {"\n"}
                  {"  "}
                  <span className="text-[var(--picsellia-green)]">
                  ...
                  <span className="text-[var(--label)]">:</span>{" "}
                  <span className="text-[var(--system-orange)]">32</span>
                  {"\n"}
                  <span className="text-[var(--label)]">{"}"})</span>
                  {"\n\n"}
                  <span className="text-[var(--tertiary-label)]">
                  ...
                  <span className="text-[var(--label)]">epoch</span>{" "}
                  <span className="text-[var(--system-indigo)]">in</span>{" "}
                  <span className="text-[var(--label)]">range(epochs):</span>
                  {"\n"}
                  {"  "}
            ...
            <div className="space-y-4">
              <div className="card p-5">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[var(--label)]">
                      Artifact Storage
                    </h4>
                    <p className="text-xs text-[var(--tertiary-label)]">
              ...
              <div className="card p-5">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded-lg bg-[var(--system-orange)]/10 flex items-center justify-center">
                    <svg
                      className="w-5 h-5 text-[var(--system-orange)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                See the exact training distribution, hyperparameters, and
                augmentations behind every performance change. Find your best
                model faster.
              </p>
      ...
      <section className="py-24 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Picsellia CV Engine is a modular toolkit for constructing computer
              vision workflows. Composable steps, framework extensions, and CLI
              automation.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-[var(--tertiary-label)] mb-4">
                Data → Model → Results. Streamlined training processes with
                built-in logic.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-2 py-1 rounded text-xs bg-[var(--system-blue)]/10 text-[var(--system-blue)]">
                  Ultralytics
                </span>
                <span className="px-2 py-1 rounded text-xs bg-[var(--system-blue)]/10 text-[var(--system-blue)]">
                  PyTorch
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-[var(--tertiary-label)] mb-4">
                Dataset transformation, pre-annotation, and data cleaning
                operations.
              </p>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="card p-0 overflow-hidden order-2 lg:order-1">
              ...
              <div className="divide-y divide-[var(--border)]">
                {[
                  ...
                  <div
                    key={model.version}
                    className={`p-4 flex items-center gap-4 ${model.current ? "bg-[var(--picsellia-green)]/5" : ""}`}
                  >
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center ${model.current ? "bg-[var(--picsellia-green)]/10" : "bg-[var(--tertiary-system-background)]"}`}
                    >
                      <span
                        className={`text-sm font-bold ${model.current ? "text-[var(--picsellia-green)]" : "text-[var(--secondary-label)]"}`}
                      >
                        {model.version}
                      </span>
                    </div>
                    ...
                    <div className="text-right">
                      <div className="text-sm font-mono text-[var(--picsellia-green)]">
                        {model.mAP.toFixed(2)}
                      </div>
                      <div className="text-[10px] text-[var(--tertiary-label)]">
                        {model.size}
      ...
      <section className="py-24 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Add predictions, compare against ground truth, and compute
              standard evaluation metrics automatically.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              { metric: "mAP@50:95", value: 0.678, description: "Strict mAP" },
              {
                metric: "Precision",
                value: 0.894,
                description: "True Positives / Predicted",
              },
              {
                metric: "Recall",
                value: 0.867,
                description: "True Positives / Actual",
              },
            ].map((item) => (
              <div key={item.metric} className="card p-5 text-center">
                ...
                <div className="text-sm font-medium text-[var(--system-blue)] mb-1">
                  {item.metric}
                </div>
          ...
          <div className="card p-12 md:p-20 text-center relative overflow-hidden border-[var(--picsellia-green)]/20">
            ...
            <div className="relative">
              ...
              <p className="text-[var(--secondary-label)] max-w-lg mx-auto mb-10 text-lg">
                Start logging metrics, comparing runs, and shipping better
