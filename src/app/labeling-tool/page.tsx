          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Leverage state-of-the-art models like SAM and DINOv2 for intelligent
                pre-labeling. Reduce manual annotation time while maintaining precision.
              </p>

              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 rounded-lg bg-[var(--tertiary-system-background)] border border-[var(--border)]">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--system-indigo)] to-[var(--system-pink)] flex items-center justify-center">
                    <span className="text-white font-bold text-sm">SAM</span>
                  </div>
                  <div>
                    <h4 className="text-sm font-semibold text-[var(--label)]">Segment Anything Model</h4>
                    <p className="text-xs text-[var(--tertiary-label)]">One-click segmentation for any object</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 p-4 rounded-lg bg-[var(--tertiary-system-background)] border border-[var(--border)]">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--system-blue)] to-[var(--system-teal)] flex items-center justify-center">
                    <span className="text-white font-bold text-xs">DINO</span>
                  </div>
                  <div>
                    <h4 className="text-sm font-semibold text-[var(--label)]">DINOv2</h4>
                    <p className="text-xs text-[var(--tertiary-label)]">Self-supervised feature extraction</p>
                  </div>
                </div>
              </div>
            </div>
