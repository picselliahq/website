      ...
      <div className="h-[calc(100%-60px)] flex items-end gap-2">
        {dataPoints.map((point, i) => (
          ...
          >
            ...
            <span className="text-[8px] text-[var(--tertiary-label)]">
              {point.time}
            </span>
          </div>
        ))}
  ...
  const anomalies = [
    {
      ...
      type: "low_confidence",
      severity: "high",
      image: "/images/use-cases/manufacturing/manufacturing-slider-1.jpg",
    },
    {
      id: 2,
      confidence: 0.45,
    ...
    },
    {
      ...
      type: "edge_case",
      severity: "medium",
      image: "/images/use-cases/energy/electric-1.jpg",
    },
  ];
    ...
    <div className="grid grid-cols-3 gap-2">
      {anomalies.map((anomaly) => (
        ...
        >
          <Image
            src={anomaly.image}
            alt={`Flagged prediction ${anomaly.id}`}
            fill
          ...
          {anomaly.severity === "high" && (
            <div className="absolute top-1 right-1">
              <svg
                className="w-3 h-3 text-[var(--system-red)]"
                fill="currentColor"
                viewBox="0 0 20 20"
              >
                <path
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--system-red)]/10 border border-[var(--system-red)]/20 mb-8">
                <svg
                  className="w-4 h-4 text-[var(--system-red)]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <span className="text-sm font-medium text-[var(--system-red)]">
                  Observability
                </span>
              </div>
              ...
              <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-lg">
                Real-time observability for computer vision models. Detect
                anomalies, track drift, and close the feedback loop
                automatically.
              </p>
              ...
              <div className="flex items-center gap-6 mb-10">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--label)] font-mono">
                    24/7
                  </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--system-red)] font-mono">
                    &lt;1%
                  </div>
                  <div className="text-xs text-[var(--tertiary-label)]">
                    Anomaly Rate
                ...
                <div className="w-px h-10 bg-[var(--border)]" />
                <div className="text-center">
                  <div className="text-2xl font-bold text-[var(--picsellia-green)] font-mono">
                    &lt;50ms
                  </div>
                  <div className="text-xs text-[var(--tertiary-label)]">
                    Latency P99
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="https://documentation.picsellia.com/docs/deployment"
                  target="_blank"
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 card px-4 py-3 shadow-xl border-[var(--system-red)]/20">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-[var(--system-red)]/10 flex items-center justify-center">
                    <svg
                      className="w-5 h-5 text-[var(--system-red)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                  ...
                  <div>
                    <div className="text-xs font-medium text-[var(--system-red)]">
                      Anomaly Detected
                    </div>
                    <div className="text-[10px] text-[var(--tertiary-label)]">
                      Low confidence spike at 12:34
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-4 -right-4 card px-3 py-2 shadow-xl">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span className="text-[var(--picsellia-green)] font-mono">
                    46ms
                  </span>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Automatic 24/7 monitoring flags anomalous inputs and
                low-confidence predictions. Reveal blindspots and discover edge
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 rounded-lg bg-[var(--tertiary-system-background)] border border-[var(--border)]">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-[var(--label)] mb-1">
                ...
                <div className="flex items-start gap-4 p-4 rounded-lg bg-[var(--tertiary-system-background)] border border-[var(--border)]">
                  <div className="w-10 h-10 rounded-lg bg-[var(--system-yellow)]/10 flex items-center justify-center flex-shrink-0">
                    <svg
                      className="w-5 h-5 text-[var(--system-yellow)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
            ...
            <div className="card p-6">
              ...
              <div className="mt-4 pt-4 border-t border-[var(--border)] flex items-center justify-between">
                ...
                <button className="text-xs text-[var(--system-red)] hover:underline">
                  Review all →
                </button>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Filter millions of inferences to identify the top anomalies. From
              edge case detection to training dataset integration in seconds.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="card p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-3xl font-bold font-mono text-[var(--label)]">
                  1.2M
                </span>
              </div>
              ...
              <div className="p-5">
                <pre className="text-xs font-mono leading-relaxed overflow-x-auto">
                  <code>
                    ...
                    {"\n"}
                    <span className="text-[var(--label)]">stats</span>{" "}
                    <span className="text-[var(--system-indigo)]">=</span>{" "}
                    <span className="text-[var(--label)]">
                      deployment.get_stats(
                    </span>
                    {"\n"}
                    {"  "}
                    <span className="text-[var(--label)]">window</span>
                    <span className="text-[var(--system-indigo)]">=</span>
                    <span className="text-[var(--picsellia-green)]">
                      &quot;24h&quot;
                    </span>
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="px-4 py-3 border-t border-[var(--border)] bg-[var(--tertiary-system-background)]">
                <div className="flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[var(--system-orange)]">
                      3 metrics drifting
                    </span>
                  </div>
                  <span className="text-[var(--tertiary-label)]">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[var(--secondary-label)] mb-8">
                Compare production data against your training baseline. Get
                alerted when distributions shift beyond acceptable thresholds.
              </p>
      ...
      <section className="py-24 border-b border-[var(--border)] relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Convert production failures into training data. Review
              predictions, attach to datasets, and trigger retraining
              automatically.
            </p>
          </div>
          ...
          <div className="card p-8 mb-12">
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
              ...
              <svg
                className="w-8 h-8 text-[var(--tertiary-label)] rotate-90 md:rotate-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-xl bg-[var(--system-red)]/10 flex items-center justify-center mb-3">
                  <svg
                    className="w-8 h-8 text-[var(--system-red)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-xl bg-[var(--system-orange)]/10 flex items-center justify-center mb-3">
                  <svg
                    className="w-8 h-8 text-[var(--system-orange)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-xl bg-[var(--picsellia-green)]/10 flex items-center justify-center mb-3">
                  <svg
                    className="w-8 h-8 text-[var(--picsellia-green)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--tertiary-label)] mb-4">
                    Automatically trigger retraining when prediction review
                    thresholds are met. Keep models fresh with production data.
                  </p>
            ...
            <div className="card p-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[var(--system-pink)]/10 flex items-center justify-center flex-shrink-0">
                  <svg
                    className="w-6 h-6 text-[var(--system-pink)]"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--tertiary-label)] mb-4">
                    Manage model promotion policies between staging and
                    production. Shadow model support for A/B testing.
                  </p>
                  <code className="text-xs font-mono text-[var(--secondary-label)] bg-[var(--black)] px-2 py-1 rounded">
