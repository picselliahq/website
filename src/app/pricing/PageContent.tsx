...
const faqs = [
  {
    ...
    answer:
      "DPU is our unit for measuring data ingestion and processing. Standard images convert at 60 images = 1 DPU, videos at 1 video = 1 DPU, and multi-spectral images at 5 images = 1 DPU.",
  },
  {
    question: "What is a Monitoring Unit (MU)?",
    answer:
      "MU measures production inference monitoring. Each MU covers 1,000 monitored predictions through the Reliability Engine for quality tracking and drift detection.",
  },
  {
    question: "Can I use modules independently?",
    answer:
      "The Data Engine can be used standalone. VisionAI Factory and Reliability Engine both require the Data Engine as a foundation. Each module includes 3 user seats.",
  },
  {
    question: "How does volume pricing work?",
    answer:
      "Volume discounts are applied based on your annual cumulative usage. As you process more data or monitor more predictions, you get better rates automatically.",
  },
  {
    question: "What about enterprise pricing?",
    answer:
      "For large deployments, we offer custom pricing with negotiated volume commitments, dedicated support, and SLAs. Contact our sales team for details.",
  },
];
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-[var(--secondary-label)] mb-10 max-w-2xl mx-auto">
              Modular platform pricing plus usage-based costs. Scale from pilot
            ...
            {platformModules.map((module) => (
              <div
                ...
                className={`card p-0 overflow-hidden relative ${
                  module.popular
                    ? "border-[var(--picsellia-green)] ring-1 ring-[var(--picsellia-green)]/20"
                    : ""
                }`}
              >
                {module.popular && (
                ...
                <div className={`p-6 ${module.popular ? "pt-10" : ""}`}>
                  ...
                  <div className="mb-6">
                    <div className="flex items-baseline gap-1">
                      <span className="text-3xl font-bold text-[var(--label)]">
                        €
                        {billingCycle === "monthly"
                          ? module.monthlyPrice.toLocaleString()
                          : (module.annualPrice / 12).toLocaleString()}
                      </span>
                    ...
                    {billingCycle === "annual" && (
                      <div className="text-xs text-[var(--tertiary-label)] mt-1">
                        €{module.annualPrice.toLocaleString()}/year billed
                        annually
                      </div>
                    )}
                  </div>
                  ...
                  <div className="pt-4 border-t border-[var(--border)] space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-mono text-[var(--label)]">
                        {module.includedUsers} seats
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-xs text-[var(--tertiary-label)]">
                      ...
                      <span className="font-mono">
                        €
                        {billingCycle === "monthly"
                          ? module.extraUserMonthly
                          : Math.round(module.extraUserAnnual / 12)}
                        /mo
                      </span>
                    </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm font-mono text-[var(--secondary-label)]">
                    €120/year
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 border-b border-[var(--border)] relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--secondary-label)] max-w-2xl mx-auto">
              Pay only for what you use. As your volume grows, your per-unit
              cost decreases automatically.
            </p>
          </div>
            ...
            <div className="card p-0 overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[var(--tertiary-label)]">
                      For data ingestion & processing
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-mono text-[var(--system-blue)]">
                      €0.80
                    </div>
              ...
              <div className="p-4">
                <div className="mb-4 p-3 rounded-lg bg-[var(--tertiary-system-background)]">
                  <div className="text-xs font-medium text-[var(--secondary-label)] mb-2">
                    Conversion rates
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-[10px]">
                    <div className="text-center">
                      <div className="font-mono text-[var(--label)]">
                        60 imgs
                      </div>
                  ...
                  <tbody>
                    {dpuTiers.map((tier, i) => (
                      <tr key={i} className="border-t border-[var(--border)]">
                        <td className="py-2 text-[var(--label)]">
                          {tier.range}
                        </td>
                        ...
                        <td className="py-2 text-right font-mono text-[var(--label)]">
                          {tier.price}
                        </td>
                      </tr>
                    ))}
            ...
            <div className="card p-0 overflow-hidden">
              <div className="px-6 py-4 border-b border-[var(--border)] bg-[var(--tertiary-system-background)]">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-[var(--tertiary-label)]">
                      For production inference monitoring
                    </p>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-mono text-[var(--system-orange)]">
                      €1.00
                    </div>
                    <div className="text-[10px] text-[var(--tertiary-label)]">
                      base price/MU
              ...
              <div className="p-4">
                <div className="mb-4 p-3 rounded-lg bg-[var(--tertiary-system-background)]">
                  ...
                  <div className="text-center">
                    <div className="font-mono text-[var(--label)] text-sm">
                      1,000 predictions = 1 MU
                    </div>
                    <div className="text-[10px] text-[var(--tertiary-label)]">
                      Each monitored inference counts as 1 prediction
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-[var(--tertiary-label)] mb-4">
                    Pay-per-use GPU allocation for training and inference. No
                    commitment required.
                  </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      <span className="text-xl font-bold font-mono text-[var(--system-pink)]">
                        €9.60
                      </span>
                      <span className="text-xs text-[var(--tertiary-label)]">
                        /hour
                  ...
                  <p className="text-sm text-[var(--tertiary-label)] mb-4">
                    Professional labeling services with trained annotators for
                    your projects.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <span className="px-2 py-1 rounded text-[10px] bg-[var(--tertiary-system-background)] text-[var(--secondary-label)]">
            ...
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[var(--secondary-label)] mb-8">
                  For organizations with high-volume needs, we offer custom
                  pricing packages with negotiated rates, dedicated support, and
                  enterprise SLAs.
                </p>
          ...
          <div className="card p-0 overflow-hidden relative">
            ...
            <div className="relative z-10 p-12 md:p-16 text-center">
              ...
              <p className="text-[var(--secondary-label)] max-w-xl mx-auto mb-10 text-lg">
                Start with a free trial or talk to our team to find the right
                plan for your needs.
              </p>
