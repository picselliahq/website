...
const FloatingElements = () => (
  <div className="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    {/* Floating data cards */}
    <div
      className="absolute top-32 right-[15%] px-3 py-2 rounded-lg bg-[var(--card)] border border-[var(--border)] shadow-xl animate-bounce hidden lg:block"
    ...
    <div
      className="absolute top-56 left-[8%] px-3 py-1.5 rounded-full bg-[var(--picsellia-green)]/10 border border-[var(--picsellia-green)]/20 text-xs font-medium text-[var(--picsellia-green)] animate-bounce hidden lg:block"
    ...
    <div
      className="absolute bottom-40 right-[12%] px-3 py-1.5 rounded-full bg-[var(--system-orange)]/10 border border-[var(--system-orange)]/20 text-xs font-medium text-[var(--system-orange)] animate-bounce hidden lg:block"
      ...
      <div className="max-w-6xl mx-auto px-6 relative">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--picsellia-blue)]/10 border border-[var(--picsellia-blue)]/20 mb-8">
            <svg
              className="w-4 h-4 text-[var(--picsellia-blue)]"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
