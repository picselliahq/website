export default function DatalakeTagsMetadata() {
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--black)] border border-[var(--border)]">
                    <span className="px-2 py-0.5 rounded bg-[var(--picsellia-blue)]/10 text-[var(--picsellia-blue)] text-xs">
                      factory-A
                    </span>
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--black)] border border-[var(--border)]">
                    <span className="px-2 py-0.5 rounded bg-[var(--picsellia-green)]/10 text-[var(--picsellia-green)] text-xs">
                      production
                    </span>
                    <span className="text-[var(--tertiary-label)] text-xs">
                      (1,892)
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--black)] border border-[var(--border)]">
                    <span className="px-2 py-0.5 rounded bg-[var(--system-orange)]/10 text-[var(--system-orange)] text-xs">
                      edge-case
                    </span>
                    <span className="text-[var(--tertiary-label)] text-xs">
                      (234)
                  ...
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--black)] border border-[var(--border)]">
                    <span className="px-2 py-0.5 rounded bg-[var(--system-indigo)]/10 text-[var(--system-indigo)] text-xs">
                      validated
                    </span>
                    <span className="text-[var(--tertiary-label)] text-xs">
                      (2,103)
              ...
              <div className="p-4 rounded-lg bg-[var(--black)] border border-[var(--border)]">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-10 h-10 rounded bg-[var(--picsellia-blue)]/20 flex items-center justify-center">
                    <svg
                      className="w-5 h-5 text-[var(--picsellia-blue)]"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] bg-[var(--system-indigo)]/10 text-[var(--system-indigo)]">
                    validated
                  </span>
                  <span className="px-2 py-0.5 rounded text-[10px] bg-[var(--system-orange)]/10 text-[var(--system-orange)]">
                    Q1-2024
                  </span>
                </div>
              </div>
  ...
  `}
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">48.8566</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;longitude&quot;
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">2.3522</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;altitude&quot;
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">35.2</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;acquired_at&quot;
  ...
  `}
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">24.0</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;sensor_width&quot;
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">36.0</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;manufacturer&quot;
  ...
  `}
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">127.5</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;pitch&quot;
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">-45.0</span>
                {`,
  `}
                <span className="text-[var(--secondary-label)]">
                  &quot;roll&quot;
                ...
                {`: `}
                <span className="text-[var(--system-orange)]">0.0</span>
                {`,
