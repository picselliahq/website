...
const capabilityDefs = [
  {
    id: 'versioning',
    titleKey: 'versioningTitle' as const,
    taglineKey: 'versioningTagline' as const,
    descKey: 'versioningDesc' as const,
    statsLabelKey: 'reproducibility' as const,
  ...
  {
    id: 'organization',
    titleKey: 'organizationTitle' as const,
    taglineKey: 'organizationTagline' as const,
    descKey: 'organizationDesc' as const,
    statsLabelKey: 'fasterDiscovery' as const,
  ...
  },
  {
    ...
    taglineKey: 'collaborationTagline' as const,
    descKey: 'collaborationDesc' as const,
    statsLabelKey: 'lessCoordination' as const,
  ...
  {
    id: 'traceability',
    titleKey: 'traceabilityTitle' as const,
    taglineKey: 'traceabilityTagline' as const,
    descKey: 'traceabilityDesc' as const,
    statsLabelKey: 'auditCompliance' as const,
...
export default function CapabilitiesGrid() {
  const t = useTranslations('datasetManagement.capabilities');
  return (
              ...
              {index === 0 ? (
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="p-6 border-t border-[var(--border)]">
                    <div className="flex items-center justify-between">
                      <div className="text-sm text-[var(--secondary-label)]">{t('fullAuditTrail')}</div>
                      <div className="text-right">
                        <div className="text-xl font-bold" style={{ color: cap.color }}>{cap.statsValue}</div>
                        <div className="text-xs text-[var(--tertiary-label)]">{t(cap.statsLabelKey)}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 h-full flex flex-col">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-lg font-bold" style={{ color: cap.color }}>{cap.statsValue}</div>
                      <div className="text-[10px] text-[var(--tertiary-label)]">{t(cap.statsLabelKey)}</div>
                    </div>
                  </div>
