...
export default function Navigation() {
  ...
  const resourcesMenu = [
    ...
    {
      label: t("resourceItems.mlopsGuide.label"),
      href: "/post/mlops-for-computer-vision-complete-guide",
      description: t("resourceItems.mlopsGuide.description"),
      icon: icons.mlopsGuide,
    },
    {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        scrolled
          ? "bg-[var(--system-grouped-background)]/95 backdrop-blur-xl border-b border-[var(--border)]"
          : ""
      }`}
    >
                            ...
                            {group.items.map((item) => (
                              ...
                              >
                                <div className="flex items-start gap-3">
                                  <div
                                    className="text-[var(--tertiary-label)] group-hover:text-[var(--label)] transition-colors mt-0.5"
                                    style={{
                                      color:
                                        openDropdown === "platform"
                                          ? undefined
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-[var(--label)] group-hover:text-[var(--picsellia-green)] transition-colors">
                            {productMenu.footer.label}
                          </span>
                        </div>
                        <svg
                          className="w-4 h-4 text-[var(--tertiary-label)] group-hover:text-[var(--picsellia-green)] group-hover:translate-x-1 transition-all"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="flex items-center gap-1.5">
                              ...
                              {item.external && (
                                <svg
                                  className="w-3 h-3 text-[var(--tertiary-label)]"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                                >
