...
export default function DeploymentHero() {
  const t = useTranslations('modelDeployment');
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--system-red)]/10 border border-[var(--system-red)]/20 mb-8">
              ...
              <span className="text-sm font-medium text-[var(--system-red)]">{t('hero.badge')}</span>
            </div>
            ...
            <div className="flex items-center gap-6 mb-10">
              <div className="text-center">
                ...
                <div className="text-xs text-[var(--tertiary-label)]">{t('hero.uptimeSla')}</div>
              </div>
              <div className="w-px h-10 bg-[var(--border)]" />
              <div className="text-center">
                <div className="text-2xl font-bold text-[var(--system-red)] font-mono">&lt;100ms</div>
                <div className="text-xs text-[var(--tertiary-label)]">{t('hero.latencyP95')}</div>
              </div>
              <div className="w-px h-10 bg-[var(--border)]" />
              <div className="text-center">
                <div className="text-2xl font-bold text-[var(--picsellia-green)] font-mono">0&rarr;&infin;</div>
                <div className="text-xs text-[var(--tertiary-label)]">{t('hero.autoScaling')}</div>
              </div>
            </div>
          ...
          <div className="relative hidden lg:block">
            <div className="card p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-[var(--picsellia-green)]">{t('hero.live')}</span>
                </div>
              ...
              <div className="p-4 rounded-lg bg-[var(--tertiary-system-background)] border border-[var(--border)]">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="px-2 py-0.5 rounded text-[10px] bg-[var(--picsellia-green)]/10 text-[var(--picsellia-green)]">{t('hero.serving')}</span>
                </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 rounded-lg bg-[var(--black)] text-center">
                  ...
                  <div className="text-[10px] text-[var(--tertiary-label)]">{t('hero.reqPerMin')}</div>
                </div>
                <div className="p-3 rounded-lg bg-[var(--black)] text-center">
                  <div className="text-lg font-bold font-mono text-[var(--system-red)]">47ms</div>
                  <div className="text-[10px] text-[var(--tertiary-label)]">{t('hero.latency')}</div>
                </div>
                <div className="p-3 rounded-lg bg-[var(--black)] text-center">
                  <div className="text-lg font-bold font-mono text-[var(--picsellia-green)]">3</div>
                  <div className="text-[10px] text-[var(--tertiary-label)]">{t('hero.replicas')}</div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[var(--tertiary-label)]">{t('hero.throughput')}</span>
                  <span className="text-[var(--label)] font-mono">{t('hero.last60s')}</span>
                </div>
            ...
            <div className="absolute -bottom-4 -left-4 card px-4 py-3 shadow-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-medium text-[var(--picsellia-green)]">{t('hero.uptime')}</div>
                  <div className="text-[10px] text-[var(--tertiary-label)]">{t('hero.last30days')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -top-4 -right-4 card px-3 py-2 shadow-xl">
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="text-[var(--tertiary-label)]">{t('hero.scaling')}</span>
                <span className="text-[var(--system-red)] font-mono">3 &rarr; 5</span>
              </div>
            </div>
          </div>
        </div>
